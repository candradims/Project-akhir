...
import DaftarPesanMasuk from "../../components/DaftarPesanMasuk";
            ...
            {displayedData.map((konselor, index) => (
              <tr key={index}>
                ...
                <td>
                  <span
                    style={{
                      color: konselor.status === "Online" ? "red" : "gray",
                    }}
                  >
                    {konselor.status}
                  </span>
                ...
                <td>
                  <Button
                    ...
                    onClick={() => navigate(`/siswa/webchat/${konselor.nama}`)}
                  >
                    Chat
                  </Button>
                </td>
