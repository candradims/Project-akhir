...
const LaporanPeriode = () => {
  ...
  const dataBK = [
    ...
    },
    {
      id: 11,
      nis: "0113456797",
      namaSiswa: "Dina Marlina",
      kelas: "X-TKJ-1",
      tanggal: "2025-07-08",
      jenis: "Pribadi",
      isi: "Kesulitan Manajemen Waktu",
      tindakan: "Konseling Individual",
      konselor: "Dr. Ahmad Wijaya, S.Pd",
    },
    {
      id: 12,
      nis: "0123456798",
      namaSiswa: "Rio Prasetyo",
      kelas: "XII-TKJ-2",
      tanggal: "2025-07-15",
      jenis: "Sosial",
      isi: "Bullying dari Senior",
      tindakan: "Mediasi dan Konseling",
      konselor: "Dra. Siti Nurhaliza, M.Pd",
    },
  ];
  ...
  const handlePrintPDF = () => {
    ...
    doc.text("LAPORAN BIMBINGAN KONSELING PER PERIODE", 148, 15, {
      align: "center",
    });
    ...
    doc.text(`Total Layanan: ${searchResult.length} kasus`, 148, 45, {
      align: "center",
    });
    ...
    doc.autoTable({
      ...
      columnStyles: {
        ...
        5: { cellWidth: 25, halign: "center" }, // Jenis
        6: { cellWidth: 65 }, // Isi
        7: { cellWidth: 50 }, // Tindakan
        8: { cellWidth: 45 }, // Konselor
      },
    ...
    // Simpan PDF
    doc.save(`Laporan-Periode-${startDate}-${endDate}.pdf`);
  };
          ...
          <div className="d-flex justify-content-between align-items-center mt-3">
            <div>
              <small className="text-muted">
                Menampilkan {searchResult.length} layanan periode {startDate} -{" "}
                {endDate}
              </small>
            </div>
            <Button
